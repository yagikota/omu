...
int main(void) {
	...
	puts("お釣り");
	printf("500円: %d枚, 100円: %d枚, 50円: %d枚, 10円: %d枚, 5円: %d枚, 1円: %d枚\n", change.coin_500, change.coin_100, change.coin_50, change.coin_10, change.coin_5, change.coin_1);
